...
if USEDF in ["Y","y"]:
	USEDF=True
	Token_Api=input("Please give your dialogflow.ai developer token:").strip()
	botIDApi=input("Please give the id of the bot in dialogflow.ai you want to use:").strip()
else: USEDF=False
